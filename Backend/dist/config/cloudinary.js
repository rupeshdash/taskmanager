...
const uploadOnCloudinary = (localFilePath) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        console.log("uploadResult", uploadResult === null || uploadResult === void 0 ? void 0 : uploadResult.url);
        ...
        console.log(error);
        fs_1.default.unlinkSync(localFilePath); //remove the locally saved temp files as the upload operation gets failed
    }
});
