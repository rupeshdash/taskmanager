      ...
      <div className="h-[90vh] w-full mx-auto max-w-3xl py-20 px-5 text-center">
        <div className="flex flex-col h-full justify-center items-center gap-3">
          <h1 className="text-2xl md:text-4xl lg:text-6xl font-bold mb-4">
            Team <span className="text-[#5051F9]">Tasks</span> Made Easy
          </h1>
          ...
          <Link to="login">
            {" "}
            <button className="text-base lg:text-lg bg-[#5051F9] text-white px-6 py-3 rounded  hover:scale-105 duration-200 font-bold">
              Get Started
            </button>
          </Link>
        </div>
